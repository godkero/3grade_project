...
from .SerialModule import Control
from .DrawPanel import GraphPanel
...
class UIPanel(wx.Panel):
    def __init__(self,parent,left):
        ...
        self.fftylimBut = wx.Button(self, -1, " set ymax:|norm|=4", pos =(150,550),size = (140,40))
        ...
        if not self.con.is_disconneted():
            ...
            try:
                if self.ylim_count == 0:
                    ...
                    self.fftylimBut.SetLabel(str("set ymax:|norm|=4"))
                elif self.ylim_count == 1:
                    self.left.ax2_y_max = 3
                    self.fftylimBut.SetLabel(str("set ymax:|norm|=3"))
                elif self.ylim_count == 2:
                    self.left.ax2_y_max = 2
                    self.fftylimBut.SetLabel(str("set ymax:|norm|=2"))
                elif self.ylim_count == 3:
                    self.left.ax2_y_max = 1
                    self.fftylimBut.SetLabel(str("set ymax:|norm|=1"))
            except: 
