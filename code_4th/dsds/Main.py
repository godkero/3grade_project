...
from .control_thread import MainControl

class Main(wx.Frame):
	def __init__(self):
		wx.Frame.__init__(
			self, parent = None, title = "0to5V Oscilloscope",
...
######
	def initUI(self):
		...
		self.leftPanel = GraphPanel(parent = self, sampleSize= 512, sampleRate= 1250000)		
